...
export class CustomerResolverBase {
  ...
  @graphql.ResolveField(() => [Authorization], { name: "authorizations" })
  async findAuthorizations(
    @graphql.Parent() parent: Customer,
    @graphql.Args() args: AuthorizationFindManyArgs
  ): Promise<Authorization[]> {
    const results = await this.service.findAuthorizations(parent.id, args);
  ...
  @graphql.ResolveField(() => [CreditCheck], { name: "creditChecks" })
  async findCreditChecks(
    @graphql.Parent() parent: Customer,
    @graphql.Args() args: CreditCheckFindManyArgs
  ): Promise<CreditCheck[]> {
    const results = await this.service.findCreditChecks(parent.id, args);
